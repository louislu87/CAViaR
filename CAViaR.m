...
d = ['save D:\Download\CAViaRCodes\NewCAViaR\TABLE', int2str(THETA(1)), ' TABLE', int2str(THETA(1)), ' -ascii -double'];
e = ['save D:\Download\CAViaRCodes\NewCAViaR\TABLE', int2str(THETA(2)), ' TABLE', int2str(THETA(2)), ' -ascii -double'];
eval(d), eval(e)
...
% Save the workspace.
save D:\Download\CAViaRCodes\NewCAViaR\Results\allmodels01_07_50
toc